...
APPNAME=mtb-example-btstack-freertos-cyw20829-switching-power-modes
...
# added to the build
#
COMPONENTS= FREERTOS PSOC6HAL WICED_BLE
...
DEFINES+=CY_RETARGET_IO_CONVERT_LF_TO_CRLF CY_RTOS_AWARE CY_CFG_PWR_DEEPSLEEP_RAM_LATENCY=20
